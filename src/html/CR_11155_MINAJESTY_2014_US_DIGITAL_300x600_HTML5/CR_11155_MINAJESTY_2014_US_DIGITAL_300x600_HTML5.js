...
// stage content:
(lib.CR_11155_MINAJESTY_2014_US_DIGITAL_300x600_HTML5_bare = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.mc_empty1).wait(2));

	// mc_loadSWF
	this.mc_loadSWF = new lib.mc_empty();
	this.mc_loadSWF.name = "mc_loadSWF";

	this.timeline.addTween(cjs.Tween.get(this.mc_loadSWF).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.mc_empty2).wait(2));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1594324128069", id:"bg"},
		{src:"images/bottle.png?1594324128069", id:"bottle"},
		{src:"images/IMAGE.jpg?1594324128069", id:"IMAGE"}
	],
	preloads: []
};
...
(lib.Stage = function(canvas) {
	createjs.this.stage.call(this, canvas);
...
an.handleSoundStreamOnTick = function(event) {
	if(!event.paused){
		var stageChild = this.stage.getChildAt(0);
